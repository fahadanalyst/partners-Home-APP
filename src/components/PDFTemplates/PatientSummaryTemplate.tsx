        ...
        <View style={{ flexDirection: 'row', gap: 12, marginBottom: 10 }}>
          ...
          <View style={{ flex: 1 }}>
            ...
            <View style={shared.card}>
              ...
              <Field label="Primary Payer ID Number" value={patient.primary_payer_id} />
        ...
        {medications.length > 0 ? (
          <View style={shared.table}>
            <View style={shared.tableHeader}>
              ...
              <Text style={[shared.tableHeaderCell, { flex: 1 }]}>Number</Text>
            ...
            {medications.map((m: any, i: number) => (
              <View key={i} style={shared.tableRow}>
                ...
                <Text style={[i % 2 === 0 ? shared.tableCell : shared.tableCellAlt, { flex: 1 }]}>{v(m.number)}</Text>
                <Text style={[i % 2 === 0 ? shared.tableCell : shared.tableCellAlt, { flex: 1 }]}>{v(m.route)}</Text>
