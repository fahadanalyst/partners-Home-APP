...
import { BasePDFTemplate, shared, BRAND, RadioGroup, CheckboxGroup } from './BasePDFTemplate';
        ...
        <Row>
          ...
          <Col>
            <View style={{ marginBottom: 8 }}>
              ...
              <RadioGroup options={['Male', 'Female']} value={patient.gender} />
            </View>
          </Col>
        </Row>
        <Row>
        ...
        <Row>
          <Col>
            <View style={{ marginBottom: 8 }}>
              ...
              <RadioGroup options={['S', 'M', 'D', 'O']} value={demographics.maritalStatus} />
            </View>
          </Col>
          <Col flex={2}>
            <Text style={shared.label}>Race / Ethnicity</Text>
            <CheckboxGroup
              options={['White', 'Black', 'Indian', 'Asian', 'Hispanic', 'Russian', 'Other']}
              selected={Array.isArray(demographics.raceEthnicity) ? demographics.raceEthnicity : []}
            />
            {(Array.isArray(demographics.raceEthnicity) && demographics.raceEthnicity.includes('Other')) ? (
              <Text style={[shared.value, { marginTop: 2 }]}>Other: {demographics.raceOther || '\u2014'}</Text>
            ) : null}
          </Col>
        </Row>
      </View>
