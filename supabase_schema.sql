...
CREATE TABLE patients (
  ...
  pharmacy_state TEXT,
  pharmacy_zip TEXT,
  transportation_company_name TEXT,
  transportation_company_phone TEXT,
  transportation_company_street TEXT,
  transportation_company_apt TEXT,
  transportation_company_city TEXT,
  transportation_company_state TEXT,
  transportation_company_zip TEXT,
  adult_day_health_name TEXT,
  adult_day_health_phone TEXT,
  adult_day_health_street TEXT,
  adult_day_health_apt TEXT,
  adult_day_health_city TEXT,
  adult_day_health_state TEXT,
  adult_day_health_zip TEXT,
  living_will TEXT,
  full_code TEXT,
  organ_donation TEXT,
